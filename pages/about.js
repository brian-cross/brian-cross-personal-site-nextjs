        ...
        <FadeIn tl={tl}>
          <div className="text-block large">
            ...
            <p>
              ...
              coding, hosting, maintenance. I'll take care of the dirty work
              while you do what you do best - run your business.
            </p>
          </div>
          <div className="text-block large">
            <h3>What's my background?</h3>
            <p>
              I started out as an electronics technologist back in the late 90s.
              I did everything from circuit board layout to designing and
            ...
            <p>
              ...
              development has come leaps and bounds since then, and I've soaked
              it all up like a sponge thirsty for knowledge.
            </p>
          </div>
          <div className="text-block large">
            ...
            <p>
              ...
              , over half of users will abandon a site that takes more than
              three seconds to load. The tools and techniques I use ensure my
            ...
            <p>
              ...
              must work properly. Not only is it good for business, it's good
              for humanity.
            </p>
            <p>
